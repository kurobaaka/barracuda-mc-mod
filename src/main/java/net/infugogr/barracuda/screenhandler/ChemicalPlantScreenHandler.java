...
import net.infugogr.barracuda.block.entity.ChemicalPlantBlockEntity;
...
public class ChemicalPlantScreenHandler extends ScreenHandler {
    private final PropertyDelegate propertyDelegate;
    private final ChemicalPlantBlockEntity blockEntity;
    private final ScreenHandlerContext context;

    public ChemicalPlantScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
    ...
    public ChemicalPlantScreenHandler(int syncId, PlayerInventory playerInventory,
                                      BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        super(ModScreenHandlerType.CHEMICAL_PLANT, syncId);

        this.propertyDelegate = arrayPropertyDelegate;
        this.blockEntity = ((ChemicalPlantBlockEntity) blockEntity);
    ...
    private void addBlockEntityInventory() {
        ...
        addSlot(new Slot(inventory.getInventory(0), 1, 8, 35));
        addSlot(new Slot(inventory.getInventory(0), 2, 8, 53));
        addSlot(new Slot(inventory.getInventory(1), 0, 34, 17));
        addSlot(new Slot(inventory.getInventory(1), 1, 34, 35));
        addSlot(new Slot(inventory.getInventory(2), 0, 134, 17));
    }
    ...
    public boolean canUse(PlayerEntity player) {
        return canUse(player, ModBlocks.CHEMICAL_PLANT);
    }
    ...
    int getInputFluid(){return this.propertyDelegate.get(5);}

    int getOutputFluid(){return this.propertyDelegate.get(6);}

    int getInputFluidVariant(){return this.propertyDelegate.get(7);}

    int getOutputFluidVariant(){return this.propertyDelegate.get(8);}
}
