...
public class UraniumGeneratorScreen extends HandledScreen<UraniumGeneratorScreenHandler> {
    private static final Identifier TEXTURE = Barracuda.id("textures/gui/container/fuel_generator_gui.png");

    public UraniumGeneratorScreen(UraniumGeneratorScreenHandler handler, PlayerInventory inventory, Text title) {
