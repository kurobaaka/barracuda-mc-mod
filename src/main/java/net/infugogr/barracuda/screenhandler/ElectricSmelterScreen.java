...
public class ElectricSmelterScreen extends HandledScreen<ElectricSmelterScreenHandler> {
    private static final Identifier TEXTURE = Barracuda.id("textures/gui/container/electric_smelter_gui.png");

    public ElectricSmelterScreen(ElectricSmelterScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        context.drawTexture(TEXTURE, this.x + 76, this.y + 32, 192, 0, burnTimeSize, 16);

        if (burnTime > 0)
            context.drawTexture(TEXTURE, this.x + 46, this.y + 51, 183, 0, 14, 14);
    }
