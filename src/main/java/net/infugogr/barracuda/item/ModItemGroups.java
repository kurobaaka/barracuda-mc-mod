    ...
    public static final ItemGroup BARRACUDA_MOD_ITEMS_GROUP_3 = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().icon(() -> new ItemStack(ModItems.REDSTONEIUM_INGOT))
                    ...
                    .entries((displayContext, entries) -> {
                        ...
                        entries.add(ModItems.GRAPHITE_PLATE);
                        entries.add(ModItems.GRAPHITE_ROD);
                        entries.add(ModItems.GRAPHITE_WIRE);
                        ...
                        entries.add(ModItems.GOLDEN_PLATE);
                        entries.add(ModItems.GOLDEN_ROD);
                        entries.add(ModItems.GOLDEN_WIRE);
                        entries.add(ModItems.REDSTONE_INGOT);
                        entries.add(ModItems.REDSTONE_CLUSTER);
                        entries.add(Items.REDSTONE);
                        entries.add(ModItems.REDSTONE_PLATE);
                        entries.add(ModItems.REDSTONE_ROD);
                        entries.add(ModItems.REDSTONE_WIRE);
                        entries.add(ModItems.LAZULI_INGOT);
                        entries.add(Items.LAPIS_LAZULI);
                        entries.add(ModItems.LAZULI_DUST);
                        entries.add(ModItems.LAZULI_PLATE);
                        entries.add(ModItems.LAZULI_ROD);
                        entries.add(ModItems.LAZULI_WIRE);
                        ...
                        entries.add(ModItems.DIAMOND_WIRE);
                        ...
                        entries.add(ModItems.EMERALD_ROD);
                        entries.add(ModItems.EMERALD_WIRE);
                        ...
                        entries.add(ModItems.NETHERITE_WIRE);
                    }).build());
