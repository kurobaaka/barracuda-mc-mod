...
public class ElectricSmelterBlock extends BlockWithEntity implements BlockEntityProvider{
    private static final MapCodec<ElectricSmelterBlock> CODEC = createCodec(ElectricSmelterBlock::new);
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;
    protected ElectricSmelterBlock(Settings settings) {
        super(settings);
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return ModBlockEntityType.ELECTRIC_SMELTER.instantiate(pos, state);
    }

    @Override
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (!world.isClient) {
            NamedScreenHandlerFactory screenHandlerFactory = ((ElectricSmelterBlockEntity) world.getBlockEntity(pos));
