...
public class ChemicalPlantBlock extends HorizontalFacingBlock implements BlockEntityProvider {
    private static final MapCodec<ChemicalPlantBlock> CODEC = createCodec(ChemicalPlantBlock::new);
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;

    protected ChemicalPlantBlock(Settings settings) {
        super(settings);
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return ModBlockEntityType.CHEMICAL_PLANT.instantiate(pos, state);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (!world.isClient && ent instanceof ChemicalPlantBlockEntity blockEntity && stack.isIn(ModTags.FLUIDS)) {
